                ...
                <div class="welcome-content">
                  ...
                  <div class="entry-content mt-5">
                    <p>
                      ...
                      libero consequat tempus. Quisque molestie convallis
                      tempus. Ut semper purus metus, a euismod sapien sodales
          ...
          <div class="row">
            <div class="col-12 col-md-6 col-lg-5">
              <div class="testimonial-cont">
                ...
                <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                  <img
                    src="images/xtestimonial-1.jpg.pagespeed.ic.cFP4cdHn4d.jpg"
                    alt=""
                  />
                  <h4>
            ...
            <div class="col-12 col-md-6 offset-lg-2 col-lg-5">
              <div class="testimonial-cont">
                ...
                <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                  <img
                    src="images/xtestimonial-2.jpg.pagespeed.ic.JByOxqmpDp.jpg"
                    alt=""
                  />
                  <h4>
